...
public class UnetDebug : MonoBehaviour {
	...
	*/
	void OnGUI()
	{
        ...
        GUI.Label(new Rect(pos.x + xDiff, Screen.height - pos.y + posY, 100, 20), "Name:" + GetComponent<NetworkIdentity>().name);
        posY += yDiff;
        ...
        if (GetComponent<NetworkIdentity>().hasAuthority) {
			GUI.Label(new Rect(pos.x+xDiff, Screen.height - pos.y + posY, 200, 20), "hasAuthority");
			posY += yDiff;
		}
