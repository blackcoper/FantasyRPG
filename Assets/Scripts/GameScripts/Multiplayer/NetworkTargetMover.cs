...
public class NetworkTargetMover : NetworkBehaviour
{
    ...
    void Start()
    {
        _leftPosition = transform.position - transform.up * _maxDistance;
        _rightPosition = transform.position + transform.up * _maxDistance;
